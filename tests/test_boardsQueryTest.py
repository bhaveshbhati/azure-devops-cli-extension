...
class BoardsQueryTests(DevopsScenarioTest): 
    ...
    def test_queryShow(self):
        ...
        show_query_command_with_id = 'az boards query --org '+ DEVOPS_CLI_TEST_ORGANIZATION +' --detect false -p ' + WI_TEST_PROJECT_NAME + ' --id 1bcb2a7e-30b0-4e49-8a1d-3ebf91219cb1 --output json'
